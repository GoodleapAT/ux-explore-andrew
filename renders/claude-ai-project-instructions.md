> **This is a render, not a source.** It is generated from `standards/working-voice.md`,
> `standards/design-memo-format.md`, `standards/diagram-conventions.md`,
> `standards/mockup-density.md` and `standards/ui-composition.md`.
>
> **Generated from the standards as at 31 August 2026. The standards have changed since.** In
> particular the memo layout moved to a full-width mockup with the argument underneath, and two
> mockup rules were added: no badges or pills, and no explanatory copy inside a screen. **This render
> is out of date and needs regenerating.**
>
> Do not edit this file to fix a rule. Fix the standard and regenerate, or you create a second source
> of truth. Where this file and a standard disagree, the standard wins.
